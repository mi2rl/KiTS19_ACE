...
def main():
    ...
    num_labels_1ststg = 1
    from src_coreline.Model_ACE_CNet import load_model as load_model_1st
    ...
    #                               SE-Unet                             #
    from src_coreline_2ndstg.Model_ACE_CNet_2ndstg import load_model as load_model_2nd
